...
def layout():
    return html.Div([
        html.Div([
            ...
            html.P("Enter your credentials to access the dashboard", 
            ...
            html.Div([
                ...
                html.A("Register here", href="/registration", style={'color': 'var(--accent)', 'fontSize': '0.9rem', 'textDecoration': 'none'})
