...
│   ├── dashboard.py               #   /dashboard route (2,653 lines)
...
├── run/run.py                     # Development convenience runner
├── data/zar_usd_hist.csv          # Historical data placeholder
└── .cache/                        # DiskCache runtime directory
```
